...
export default class UpdateFeedback extends Component{
 ...
 handleSubmit(event){
    ...
    fetch('https://rfqapigateway.azure-api.net/Supplier/api/Supplier/UpdateFeedback', {
        method: 'PUT',
        headers: {
            'accept': '*/*',
        ...
        <Modal 
          ...
          >
            ...
            <Form.Group className="mb-3" controlId="feedback">
              ...
              <Form.Control type="number" placeholder="Enter feed back" pattern='[0-9]{2}' required defaultValue={this.props.feedback}/>
