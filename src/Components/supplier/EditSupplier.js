...
export default class Editsupplier extends Component{
 ...
 handleSubmit(event){
    ...
    fetch('https://rfqapigateway.azure-api.net/Supplier/api/Supplier/Update', {
        method: 'PUT',
        headers: {
            'accept': '*/*',
        ...
        .catch(error => {this.setState({snackbaropen:true,snackbarmsg:'Supplier update Failed'})})
        ...
        <Modal 
          ...
          >
            ...
            <Form.Group className="mb-3" controlId="suppliername">
              ...
              <Form.Control type="text" placeholder="Enter supplier name" pattern='[a-zA-Z]+'  required  defaultValue={this.props.name}/>
            ...
            <Form.Group className="mb-3" controlId="feedback">
              ...
              <Form.Control type="number" placeholder="Enter feed back" pattern='[0-9]{1}' required defaultValue={this.props.feedback}/>
